    ...
    <section className="border-t border-zinc-800/60 px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative">
          <div
            className="absolute left-[7px] top-2 bottom-2 w-px bg-gradient-to-b from-emerald-500/50 via-emerald-400/30 to-transparent sm:left-3"
            aria-hidden
          />
          <ol className="flex flex-col gap-14">
            {experience.map((job, i) => (
              ...
              >
                <span
                  className="absolute left-0 top-1.5 flex h-4 w-4 items-center justify-center rounded-full border-2 border-emerald-400/80 bg-zinc-950 sm:left-1"
                  aria-hidden
                >
